...
class LevelEditorFrame(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        # Empty
        self.emptyImage = wx.Bitmap(
                            asset_data.EmptyTile).ConvertToImage().Scale(
        ...
        # Player
        self.playerImage = wx.Bitmap(
                        asset_data.PlayerTile).ConvertToImage().Scale(
                            define_level_editor_data.TOOLBAR_SIZE,
                            define_level_editor_data.TOOLBAR_SIZE)
        ...
        # Enemy
        self.enemyImage = wx.Bitmap(
                    asset_data.EnemyTile).ConvertToImage().Scale(
                        define_level_editor_data.TOOLBAR_SIZE,
                        define_level_editor_data.TOOLBAR_SIZE)
        ...
        # Eraser
        self.eraserImage = wx.Bitmap(
                            asset_editor_data.Eraser).ConvertToImage().Scale(
                                define_level_editor_data.TOOLBAR_SIZE,
                                define_level_editor_data.TOOLBAR_SIZE)
        ...
        # Arrow Left
        self.arrowLeftImage = \
            wx.Bitmap(asset_editor_data.ArrowLeft).ConvertToImage().Scale(
                      define_level_editor_data.TOOLBAR_SIZE,
                      define_level_editor_data.TOOLBAR_SIZE)
        ...
        # Arrow Right
        self.arrowRightImage = \
            wx.Bitmap(asset_editor_data.ArrowRight).ConvertToImage().Scale(
                        define_level_editor_data.TOOLBAR_SIZE,
                        define_level_editor_data.TOOLBAR_SIZE)
    ...
    def setCurrentLevel(self,
        ...
        self.backBuffer = wx.Bitmap(
           ...
           *
           (define_level_editor_data.GRID_SIZE + 1) + 1,
    ...
    def OnNewPackage(self, event):
        ...
        if self.createNewLevel() is False:
...
class LevelEditorPanel(wx.Panel):
    ...
    def __init__(self,
        ...
        super(LevelEditorPanel, self).__init__(parent)
