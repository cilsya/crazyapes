...
class Level(object):
    ...
    def update(self,
        ...
        for spr in level_data.NPC:
            ...
            if spr.updateSprite() is True:
                spr.idleUpdate()

            # if spr.isAlive() == True:
            if spr.isAlive() is True:
    ...
    def keyPress(self,
        ...
        if self.player is not None:
            ...
            if self.player.keyPress(c) is True:
                return True
    ...
    def numEnemies(self):
        ...
        list_enemy_type = []
        for enemy_ in level_data.NPC:
            if enemy_.classID == sprite_data.Enum.ENEMY_CLASSID:
                list_enemy_type.append(enemy_)
